...
public class ListingServiceTests {
	...
	public void testCreateArtwork() {
		...
		try {
			artwork = listingService.createArtwork(ARTWORK_NAME, YEAR, PRICE, PROMOTED, STYLE, HEIGHT, WEIGHT, WIDTH, artist, gallery);
	...
	public void testCreateArtworkArtistNull() {
		...
		Artwork artwork = null;
		try {
			artwork = listingService.createArtwork(ARTWORK_NAME, YEAR, PRICE, PROMOTED, STYLE, HEIGHT, WEIGHT, WIDTH, null, gallery);
		} catch (IllegalArgumentException e) {
			//e.printStackTrace();
		...
		public void testCreateArtworkGalleryNull() {
			...
			Artwork artwork = null;
			try {
				artwork = listingService.createArtwork(ARTWORK_NAME, YEAR, PRICE, PROMOTED, STYLE, HEIGHT, WEIGHT, WIDTH, artist, null);
			} catch (IllegalArgumentException e) {
				//e.printStackTrace();
			...
			public void testCreateArtworkNoName() {
				...
				Artwork artwork = null;
				try {
					artwork = listingService.createArtwork(null, YEAR, PRICE, PROMOTED, STYLE, HEIGHT, WEIGHT, WIDTH, artist, gallery);
				} catch (IllegalArgumentException e) {
					//e.printStackTrace();
			...
			public void testCreateArtworkNoYear() {
				...
				Artwork artwork = null;
				try {
					artwork = listingService.createArtwork(ARTWORK_NAME, null, PRICE, PROMOTED, STYLE, HEIGHT, WEIGHT, WIDTH, artist, gallery);
				} catch (IllegalArgumentException e) {
					//e.printStackTrace();
			...
			public void testCreateArtworkNoPrice() {
				...
				Artwork artwork = null;
				try {
					artwork = listingService.createArtwork(ARTWORK_NAME, YEAR, null, PROMOTED, STYLE, HEIGHT, WEIGHT, WIDTH, artist, gallery);
				} catch (IllegalArgumentException e) {
					//e.printStackTrace();
			...
			public void testCreateArtworkNoStyle() {
				...
				Artwork artwork = null;
				try {
					artwork = listingService.createArtwork(ARTWORK_NAME, YEAR, PRICE, PROMOTED, null, HEIGHT, WEIGHT, WIDTH, artist, gallery);
				} catch (IllegalArgumentException e) {
					//e.printStackTrace();
			...
			public void testCreateArtworkNoHeight() {
				...
				Artwork artwork = null;
				try {
					artwork = listingService.createArtwork(ARTWORK_NAME, YEAR, PRICE, PROMOTED, STYLE, null, WEIGHT, WIDTH, artist, gallery);
				} catch (IllegalArgumentException e) {
					//e.printStackTrace();
			...
			public void testCreateArtworkNoWeight() {
				...
				Artwork artwork = null;
				try {
					artwork = listingService.createArtwork(ARTWORK_NAME, YEAR, PRICE, PROMOTED, STYLE, HEIGHT, null, WIDTH, artist, gallery);
				} catch (IllegalArgumentException e) {
					//e.printStackTrace();
			...
			public void testCreateArtworkNoWidth() {
				...
				Artwork artwork = null;
				try {
					artwork = listingService.createArtwork(ARTWORK_NAME, YEAR, PRICE, PROMOTED, STYLE, HEIGHT, WEIGHT, null, artist, gallery);
				} catch (IllegalArgumentException e) {
					//e.printStackTrace();
			...
			public void testCreateListing() {
				...
				assertEquals(listing.getListingID(), artwork.getArtworkID() * artwork.getArtists().iterator().next().getUsername().hashCode());
			}
			...
			public void testAddArtist() {
				...
				assertEquals(updatedArtwork.getArtists().iterator().next().getUsername(), ARTIST_USERNAME2);
			}
