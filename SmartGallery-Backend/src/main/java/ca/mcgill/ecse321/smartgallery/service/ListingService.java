...
public class ListingService {
	 ...
	 */
	@Transactional
	public Artwork createArtwork(String name, Integer year, Double price, boolean isBeingPromoted, ArtStyle style,
			Integer height, Integer weight, Integer width, Artist artist, Gallery gallery) {
		String error = "";
	...
	public void setArtworkImageUrl(Artwork artwork, String imageUrl) {
		...
		System.out.println(
				"Saved image url: " + artworkRepository.findArtworkByArtworkID(artwork.getArtworkID()).getImageUrl());
	}
	...
	public Listing createListing(Artwork artwork, Date dateListed, Double price, Gallery gallery) {
		...
		if (artwork != null && artwork.getArtists() != null && listingRepository.findListingByListingID(
				artwork.getArtworkID() * artwork.getArtists().iterator().next().getUsername().hashCode()) != null) {
	...
	@Transactional
	public Artwork updateArtworkListed(Listing listing, String name, Integer year, Double price, ArtStyle style,
			Integer height, Integer width, Integer weight) {
	...
	public Artwork deleteListingAndArtwork(Listing listing) {
		...
		if (artwork.getInterestedProfile() != null) {
	 ...
	 * @author Stavros Mitsoglou
	 * @param artworkID
	 * @return This method returns an artwork from its id.
	 */
	@Transactional
	...
	/**
	 * @author Stavros Mitsoglou
	 * @return all artworks Return all artworks in Repository
	 */
